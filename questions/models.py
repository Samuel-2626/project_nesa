...
class Question(models.Model):
    ...
    author = models.ForeignKey(
        User, on_delete=models.SET_NULL, related_name="my_questions", null=True
    )
    ...
    tags = TaggableManager(
        help_text="A list of comma separated values. e.g healtheconomics, macroeconomics, etc."
    )
...
class QuestionViews(models.Model):
    ...
    question = models.ForeignKey(
        Question, on_delete=models.CASCADE, related_name="question_views"
    )
...
class Answer(models.Model):
    ...
    author = models.ForeignKey(
        User, on_delete=models.SET_NULL, related_name="my_answers", null=True
    )
...
class QuestionVotes(models.Model):
    ...
    author = models.ForeignKey(
        User, on_delete=models.SET_NULL, related_name="my_vote_questions", null=True
    )
    question = models.ForeignKey(
        Question, on_delete=models.CASCADE, related_name="questions_votes"
    )
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
...
class VoteAnswer(models.Model):
    ...
    answer = models.ForeignKey(
        Answer, on_delete=models.CASCADE, related_name="answers_votes"
    )
    author = models.ForeignKey(
        User, on_delete=models.SET_NULL, related_name="my_vote_answers", null=True
    )
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
    status = models.CharField(max_length=10, choices=STATUS_CHOICES)
