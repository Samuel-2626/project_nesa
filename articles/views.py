...
def post_article(request):
    ...
    if request.user.profile.reputation < 100:
        ...
        messages.success(request, '<b>Access Denied:</b> You need atleast 100 reputation to post an article <a href="https://nesaacademy.com/help/#posting-article" style="color:#DDAF94;">Learn more</a>', extra_tags='safe')
